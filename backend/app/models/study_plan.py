...
class StudyPlan(Base, SerializerMixin):
    ...
    study_plan_lessons = relationship("StudyPlanLesson", back_populates="study_plan",
                                     cascade="all, delete-orphan", order_by="StudyPlanLesson.sequence_order")
...
class StudyPlanCourse(Base, SerializerMixin):
    ...
    # Custom content if lesson_id is NULL
    ...
    course = relationship("MicroCourse", back_populates="study_plan_courses")
