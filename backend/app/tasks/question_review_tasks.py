...
def notify_kaihle_admins_of_review_item(
    ...
    try:
        loop.run_until_complete(_send_review_notification(review_item_id, item_type, submitted_by_id))
    except Exception as exc:  # noqa: BLE001
        logger.error(
            "notify_kaihle_admins_failed",
...
async def _send_review_notification(
    ...
    """Load admin emails and send the notification."""
