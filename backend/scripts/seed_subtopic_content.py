...
from app.services.youtube_service import search_youtube_videos as _yt_search
...
def search_youtube_videos(subtopic: dict[str, Any], yt_client: Any = None) -> list[dict[str, Any]]:
    """Delegate to app.services.youtube_service — shared with the API refresh endpoint."""
    return _yt_search(subtopic, yt_client=yt_client, api_key=settings.youtube_data_api_key)
