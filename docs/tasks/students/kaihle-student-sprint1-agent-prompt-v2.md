...
#
# Usage: claude --task docs/tasks/student/kaihle-student-sprint1-agent-prompt.md
...
Primary task file:    docs/tasks/student/kaihle-student-tasks-v2.md
Architecture doc:     docs/tasks/student/kaihle-concept-guide-architecture.md  (ST-020 only)
...
6.  docs/tasks/student/kaihle-student-tasks-v2.md
```
...
Read `docs/tasks/student/kaihle-concept-guide-architecture.md` in full before starting.
