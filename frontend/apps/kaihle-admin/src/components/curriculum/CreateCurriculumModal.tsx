/**
 * CreateCurriculumModal - Modal for creating a new curriculum board.
 *
 * Fields: Name (required, max 200), Code (required, max 50, slug hint),
 * Description (optional), Country (optional), Active toggle (default true)
 */
...
export function CreateCurriculumModal({
  ...
  return (
    <Modal
      ...
      description="Add a new curriculum board to the platform."
      maxWidth="md"
    >
      <form onSubmit={handleSubmit} className="space-y-4 mt-4">
        ...
        <div>
          ...
          <p className="mt-1 text-xs text-gray-500">
            Unique identifier, lowercase, no spaces (e.g., cambridge-lower,
            igcse)
          </p>
          {fieldErrors.code && (
        ...
        <div>
          <label
            htmlFor="curriculum-country"
            className="block text-sm font-medium text-gray-700 mb-1"
          >
            Country
          </label>
          <input
            id="curriculum-country"
            type="text"
            value={country}
