            ...
            <div className="bg-white border border-role-school-border rounded-xl p-5">
              ...
              {unassignedCount > 0 && (
                <div className="text-xs text-brand-body">
                  {unassignedCount}{" "}
                  {unassignedCount === 1 ? "class" : "classes"} unassigned
                </div>
              )}
            </div>
              ...
              {analytics?.at_risk_students.length ? (
                <>
                  ...
                  {analytics.at_risk_students.length > 5 && (
                    <button
                      onClick={() =>
                        navigate("/school-admin/users?tab=students")
                      }
              ...
              <div className="bg-white border border-role-school-border rounded-xl p-5">
                ...
                {pendingOnboarding > 0 && (
                  <button
                    onClick={() =>
                      navigate(
                        "/school-admin/users?tab=students&filter=pending",
                      )
                    }
