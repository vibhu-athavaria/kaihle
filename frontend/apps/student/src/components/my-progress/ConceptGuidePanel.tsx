...
// Content without the wrapper card — used by the drawer shell
export function ConceptGuidePanelContent({
  subtopicId,
  subtopicName: _subtopicName, // displayed in drawer header, not repeated here
  masteryScore: _masteryScore, // reserved for future multi-turn personalisation
  onClose: _onClose, // drawer header provides its own close; kept for API parity
}: {
  subtopicId: string;
  subtopicName: string;
  ...
  return (
    <div className="p-4 space-y-4">
      ...
      {guideError && (
        <div className="text-brand-red text-xs font-sans">
