        ...
        <>
          ...
          <div className="py-2 px-6">
            {profile?.modalities?.map((modality) => {
              ...
              return (
                ...
                >
                  <span className="text-sm text-brand-ink w-36 font-sans">
                    {modality.modality}
                  </span>
                  <div className="h-2 rounded-full flex-1 bg-brand-border">
                    <div
                      className={`h-full rounded-full transition-all duration-600 ease-out ${
                        isDominant ? "bg-brand-primary" : "bg-brand-muted"
                      }`}
                  ...
                  <span className="text-sm text-brand-muted w-10 text-right">
            ...
            <div className="px-6 pb-4">
              <div className="flex flex-wrap gap-2">
                {profile.interests.map((interest) => (
                  <span
                    key={interest}
                    className="bg-brand-green-light text-brand-primary border border-brand-mid text-xs rounded-full px-3 py-1"
                  >
                    {interest}
                  </span>
                ))}
          ...
          <div className="mx-6 mb-6">
            <button
              ...
              className="border border-brand-primary text-brand-primary rounded-xl px-4 py-2 text-sm font-medium w-full hover:bg-brand-green-light transition-colors min-h-[44px] focus-visible:ring-2 focus-visible:ring-brand-primary focus-visible:ring-offset-2"
            >
