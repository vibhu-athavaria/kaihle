  ...
  const handleSubmit = async () => {
    ...
    try {
      await apiClient.post("/api/v1/onboarding/questionnaire/submit", {
        q1_preferred_medium: answers.q1_preferred_medium,
        q2_learning_pace: answers.q2_learning_pace,
        q3_help_preference: answers.q3_help_preference,
        q4_environment: answers.q4_environment,
        q5_goal: answers.q5_goal,
