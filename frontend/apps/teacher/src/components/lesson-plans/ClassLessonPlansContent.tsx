...
export function StatusBadge({ status }: { status: LessonPlan["status"] }) {
...
interface ClassLessonPlansContentProps {
  classId: string;
}

export function ClassLessonPlansContent({
  classId,
}: ClassLessonPlansContentProps) {
