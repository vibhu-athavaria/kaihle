                    ...
                    <div className="flex items-center justify-end gap-2">
                      {(assessment.status === "ACTIVE" ||
                        ...
                        >
                          <button
                            type="button"
                            className="flex items-center gap-1.5 text-xs font-sans font-bold text-brand-primary hover:text-brand-dark focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-gold rounded px-2 py-1"
                          >
                            <BarChart2
